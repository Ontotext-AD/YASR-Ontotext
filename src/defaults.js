...
module.exports = {
	...
	persistency: {
		...
		/**
		 * Setting to true will use the translation service to translate the header variables
		 * looking for them in the translation bundles as keys under "yasr.headers.labels"
		 * e.g. "yasr.headers.labels.subject"
		 */
